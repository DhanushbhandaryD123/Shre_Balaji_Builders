...
export const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({
  ...
  return (
    <aside
      ...
      className="fixed bottom-6 left-6 z-40 flex flex-col gap-3.5 items-start pointer-events-auto"
    >
      {/* 1. Real Phone Call Icon Floating Button (Left Side) */}
      <div className="relative flex items-center group">
        <a
          href="tel:+919740763625"
          className="w-13 h-13 sm:w-14 sm:h-14 rounded-full bg-gradient-to-br from-navy via-navy to-navy-950 text-gold hover:text-white border-2 border-gold/60 flex items-center justify-center shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95 hover:bg-maroon hover:border-white/50"
      ...
      <div className="relative flex items-center group">
        <a
          ...
          className={`w-13 h-13 sm:w-14 sm:h-14 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-white flex items-center justify-center shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95 border-2 border-white/40 ${
